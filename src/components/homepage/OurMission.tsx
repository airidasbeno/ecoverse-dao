                        ...
                        <div className={`${styles["col-text"]}`}>
                            <div className={`${styles.content}`}>
                                ...
                                <p>Our decentralized autonomous organization (DAO) thrives on active participation, and
                                    your voice matters. Be a part of nature conservation campaigns! By leveraging
                                    WalletConnect, a secure bridge between your wallet
                                ...
                                <p>Elevate your involvement in our community-driven conservation initiatives by
                                    embracing this
                                ...
                                <p>The EcoVerse DAO Team is a dedicated and diverse group of individuals united by a
                                    ...
                                    fosters innovation, sustainability, conservation and community engagement.
                                    Comprising experts
